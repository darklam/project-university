...
HashMap<int>* Pairs::createDataset(List<Entry<Set*>*>* positive, Clique *clique){
  auto pairs = new HashMap<int>(50000);
...
HashMap<int>* Pairs::PairsToDataset(CustomVector<Pair*>* pairs){
